...
We will be using [RStudio Cloud](https://rstudio.cloud/) for computing.
  ...
  - Mixtape: [properties of regression](https://mixtape.scunning.com/ch1.html), *[directed acyclical graphs](https://mixtape.scunning.com/ch2.html), [potential outcomes causal model](https://mixtape.scunning.com/ch3.html)*
