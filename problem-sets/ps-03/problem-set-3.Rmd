...
3. In `storms`: create a single date-time variable from the year, month, day, hour variables; then convert the date-time into a date variable using `lubridate` (hint: you might need to google some stuff or find the online cheat sheet for lubridate)
