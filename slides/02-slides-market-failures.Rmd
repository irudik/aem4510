...
```{r, echo = FALSE}
embed_url("https://youtu.be/yRUs_gLgpx4") %>%
  use_align("center")
```
...
```{r, echo = FALSE}
embed_url("https://youtu.be/JLHXYTbSQZY") %>%
  use_align("center")
```
...
```{r, echo = FALSE}
embed_url("https://youtu.be/17lldWWxYC0") %>%
  use_align("center")
```
...
```{r, echo = FALSE}
embed_url("https://youtu.be/4vcdJ2Zsc8U") %>%
  use_align("center")
```
...
Because at each quantity/depth, only certain groups are willing to use the river
...
At quantities =< 6 all groups are willing to pay to use the river
