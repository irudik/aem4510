...
# No markets lead to issues in the Southwest

```{r, echo = FALSE}
local_video("videos/02-market-failures-southwest-water.mp4")
```

---

# No markets lead to issues in Arizona
...
The private actors are not accounting for the .hi[external costs] they are imposing on people who are not in the DDT transaction (e.g. third parties whose health is being affected)
...
# COVID and positive externalities

```{r, echo = FALSE}
local_video("videos/02-market-failures-covid-externalities-1.mp4")
```
...
```{r, echo = FALSE}
local_video("videos/02-market-failures-covid-externalities-2.mp4")
```
...
At quantities =< 6 all groups are willing to pay
