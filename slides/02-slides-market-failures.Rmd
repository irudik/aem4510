...
Markets rely on prices to reflect value and have people make good decisions
...
ggplot() +
  ...
  scale_x_continuous(limits = c(0,31), expand = c(0,0), breaks = scales::breaks_pretty()) +
  scale_y_continuous(limits = c(0,13), expand = c(0,0), breaks = scales::breaks_pretty()) +
  labs(x = "Quantity",
...
ggplot() +
  ...
  scale_x_continuous(limits = c(0,31), breaks = 22/3, labels = "22/3", expand = c(0,0)) +
  scale_y_continuous(limits = c(0,13), breaks = 22/3, labels = "22/3", expand = c(0,0)) +
  labs(x = "Quantity",
       y = "Marginal Benefit/Marginal Cost")
