...
Firm 2 can buy the right to emit 1 unit of pollution from firm 1 for anywhere between 1.25-0.83=.42 and .hi[both will be better off]
...
If we set $\bar{E}$ such that the equilibrium permit price $p = d$, then we also have efficiency
...
.hi-blue[Auction] charge firms for each permit they hold, let price be set by marketplace, revenues can be used to reduce other distortionary taxes, auction price will be the same as a Pigouvian tax
