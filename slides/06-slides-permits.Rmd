...
ggplot() +
  stat_function(fun = mac1, color = "#ca5670", linewidth = 1.5) +
...
.pull-left[
```{r permits-auction-supply-demand, echo = FALSE, fig.show = 'hide', warning = F, dependson = "permits-auction-demand"}
...
.footnote[
<sup>1</sup> The EU ETS and California-Quebec also charge the lowest winning bid; RGGI charges the highest losing bid.
]
...
.pull-left[
```{r permits-auction-clearing, echo = FALSE, fig.show = 'hide', warning = F, dependson = "permits-auction-demand"}
