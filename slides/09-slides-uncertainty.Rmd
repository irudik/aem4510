...
<!-- Auto-rebuild: ls slides/09-slides-uncertainty.Rmd | entr -c Rscript -e "rmarkdown::render('slides/09-slides-uncertainty.Rmd')" -->
...
```{r, echo = FALSE}
local_video("videos/09-uncertainty-arctic-sea-ice.mp4")
```
