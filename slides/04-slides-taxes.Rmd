...
The tax is the MC of emitting, the MAC is the marginal benefit of emitting (reduced abatement cost)
...
The optimal tax is equal to the MD at the optimal emission level
...
In addition to paying abatement cost equal to the red area $B$, the firm also has subsidy **revenues** equal to the blue area $F+G$
