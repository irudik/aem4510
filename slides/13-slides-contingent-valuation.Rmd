...
<!-- Auto-rebuild: ls slides/13-slides-contingent-valuation.Rmd | entr -c Rscript -e "rmarkdown::render('slides/13-slides-contingent-valuation.Rmd')" -->
...
.center[
<!-- Original tweet: https://twitter.com/Undercoverhist/status/879094178470387712 -->
<!-- TODO: Add screenshot to files folder and uncomment below -->
<!-- ![CVM tweet](files/cvm-tweet.png) -->
]
