...
$PV_A = \frac{4000}{1.05^1} + \frac{4000}{1.05^2} + \frac{4000}{1.05^3} - \frac{10000}{1.05^0} - \frac{1000}{1.05^1} = 1791.76$

**Project B:**

$PV_B = \frac{1000}{1.05^1} + \frac{3000}{1.05^2} + \frac{3000}{1.05^3} - \frac{6000}{1.05^0} = 1648.09$
...
$PV_A = \frac{4000}{1.03^1} + \frac{4000}{1.03^2} + \frac{4000}{1.03^3} - \frac{10000}{1.03^0} - \frac{1000}{1.03^1} = 2262.35$

**Project B:**

$PV_B = \frac{1000}{1.03^1} + \frac{3000}{1.03^2} + \frac{3000}{1.03^3} - \frac{6000}{1.03^0} = 2144.69$
...
With a decent amount of math we can show that the social discount rate $r$ is composed of three terms:
$$r = \delta + \eta \times g$$
...
$\eta$ is the .hi[elasticity of marginal utility]: how quickly does marginal utility (benefit) decline in consumption?
...
knitr::include_graphics("files/10-experts-1.png")
```
</center>
...
<center>
```{r, out.width = "70%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/10-experts-2.png")
```
</center>
...
<center>
```{r, out.width = "70%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/10-experts-3.png")
```
</center>
...
<center>
```{r, out.width = "70%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/10-experts-4.png")
```
</center>
...
<center>
```{r, out.width = "70%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/10-experts-5.png")
```
</center>
...
<center>
```{r, out.width = "70%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/10-experts-6.png")
```
</center>
...
<center>
```{r, out.width = "70%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/10-discounting-1.png")
```
</center>
...
<center>
```{r, out.width = "70%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/10-discounting-2.png")
```
</center>
...
<center>
```{r, out.width = "70%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/10-discounting-3.png")
```
</center>
...
<center>
```{r, out.width = "70%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/10-discounting-4.png")
```
</center>
...
- .hi[Leasehold:] temporary, pre-paid, tradable ownership contracts with maturities of 99-999 years, one it expires, you lose the property
...
Let's think about a simple example: imagine you are a real estate investor deciding on purchasing a property to add to your rental portfolio in a competitive property market
...
The benefit of the property is the present value of the sum of future rental payments

--

Suppose buyers were competing for a property that has a present value future rental stream of $900,000, what market price would we expect someone to pay for this?

--

.hi[$900,000!] investors will compete, bidding higher and higher prices until it reaches the benefits of owning the property (same logic as why prices are the MB of other goods)
...
Both properties are identical until year 500 when .hi-blue[poof], you no longer own property A but you still own property B
...
- .hi[Changes in growth:] if growth slows down, discount rates fall
    - The future is getting richer slower, so the future's marginal value of a dollar is higher than if growth did not slow
    
--

- .hi[Uncertainty:] if we are uncertain about future economic conditions determining the discount rate, the discount rate we should use is lower than the average (expected) discount rate
...
Suppose climate change is going to impose 1 trillion dollars of costs in 100 years
...
We think that in 100 years growth will either be 0% or 6%, each with 50% chance

--

What are the current expected costs of the damage?
...
- leases expiring with 100 years cost 17% less than a freehold
...
.pull-right[
```{r, out.width = "100%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/10-long-run-discount-1.png")
```
]
...
- leases expiring with 70 years cost 40% less than a freehold
...
.pull-right[
```{r, out.width = "100%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/10-long-run-discount-2.png")
```
]
...
There's no reason the rent you pay for your house should depend on how much longer the owner has property rights
...
.pull-right[
```{r, out.width = "100%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/10-long-run-discount-3.png")
```
]