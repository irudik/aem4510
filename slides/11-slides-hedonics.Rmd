...
Property value approaches are called .hi-blue[hedonics] because they rely on the hedonic economic model
...
\begin{align}
  {\partial U \over \partial x_j} =& {\partial U \over \partial z} {\partial P \over \partial x_j} \,\,\, j=1,\dots,J \\
...
The bid function $b(x,q,y,s,\bar{u})$ is the .hi-red[maximum WTP] of the household for:  
...
--
and since $P = WTP$ in markets, 
--
we can plug $b$ in for the hedonic price function:
...
Next, differentiate with respect to $q$ to get:
...
We just proved that the maximum WTP for $q$ is given by how housing prices change in $q$
