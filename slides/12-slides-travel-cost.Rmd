...
<!-- Auto-rebuild: ls slides/12-slides-travel-cost.Rmd | entr -c Rscript -e "rmarkdown::render('slides/12-slides-travel-cost.Rmd')" -->
...
```{r, echo = FALSE}
local_video("videos/12-travel-cost-great-lakes-carp.mp4")
```
