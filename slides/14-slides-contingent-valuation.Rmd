...
<!-- Auto-rebuild: ls slides/14-slides-contingent-valuation.Rmd | entr -c Rscript -e "rmarkdown::render('slides/14-slides-contingent-valuation.Rmd')" -->
...
```{r, echo = FALSE}
local_video("videos/14-cv-exxon-valdez.mp4")
```
