...
<!-- Auto-rebuild: ls slides/14-slides-hedonics.Rmd | entr -c Rscript -e "rmarkdown::render('slides/14-slides-hedonics.Rmd')" -->
...
```{r, echo = FALSE}
local_video("videos/14-hedonics-superfund.mp4")
```
...
knitr::include_graphics("files/14-ithaca-housing-prices-1.png")
```
```{r, out.width = "80%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/14-ithaca-prices.png")
```
</center>
...
<center>
```{r, out.width = "80%", fig.pos="c", echo = FALSE}
knitr::include_graphics("files/14-dyson-home.png")
```
</center>
...
knitr::include_graphics("files/14-zoom-in.png")
```
</center>
