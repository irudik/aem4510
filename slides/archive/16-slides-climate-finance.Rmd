...
<!-- Auto-rebuild: ls slides/16-slides-climate-finance.Rmd | entr -c Rscript -e "rmarkdown::render('slides/16-slides-climate-finance.Rmd')" -->
...
Which are less risky for lenders?
...
The price of a bond should be equal to the expected present value cash flow
