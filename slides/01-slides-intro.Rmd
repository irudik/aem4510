...
.hi[TAs:] Chrisma D'Souza, Nathan Bol, Becca Ford

.hi[Office hours:] see canvas
...
.hi[4 prelims (20% each):] 
  - Feb 12, Mar 17, Apr 14, May 5
  - Prelims will be a combination of multiple choice, short answer, graphical, and simple mathematical questions that will not require a calculator
  ...
  - No makeup prelims: if you miss a prelim, it's weight is equally distributed to your other prelims


---

# Grading
.hi[4 Problem Sets (5% each):] mix of quantitative and conceptual problems to give you practice in learning key concepts (teams of 3)
  - 1 before each prelim: Feb 10, Mar 12, Apr 9, Apr 30
  - Solutions posted immediately after the deadline
  - No late submissions
...
No recording or sharing of materials outside class: Each person in this class is expected to respect the principles of academic freedom for instructors and classmates and will maintain the privacy of the classroom environment, as outlined in Cornell's Code of Academic Integrity.

No use of electronics in class: the use of laptops, tablets, phones, or other electronics in class is prohibited. Notes must be taken on paper.
...
I post slides after we finish each section so you will not miss any content

---

# Last words

This was just an overview, canvas has a lot more details about specific requirements
