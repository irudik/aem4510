...
.hi[5 prelims (20% each):] canvas-based, simple questions (solo)
  - 5 in class prelims + final: lowest score is dropped
...
.hi[Weeks 7-14ish:] using markets (real and financial) to tell us about the environment
...
.pull-left[
```{r sequoia-tweet, out.width = "200px", echo = FALSE, fig.pos="c"}
